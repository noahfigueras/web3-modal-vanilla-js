...
const contractAddress = "0xfF50EaBc540B5389dE3a68D86fD8d03aDeDbAD05";
...
async function mint() {
    ...
    const totalCost = await nftContract.cost() * amount;
...
async function amountLeft() {
    ...
    try{
        const maxAmount = await nftContract.maxSupply();
